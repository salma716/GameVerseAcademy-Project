...
<head>
    ...
    <title>GameVerse Academy — Modifier un Mod</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .nav-a {
            ...
            text-decoration:none; color:var(--text-mid); font-size:.82rem; transition:all .2s; margin-bottom:.12rem; position:relative;
        }
        ...
        .ph h1 {
            font-family:'Cinzel',serif; font-size:2rem; font-weight:700; letter-spacing:.04em;
        ...
        .form-card {
            ...
            padding:2rem; max-width:680px; position:relative; overflow:hidden;
        ...
        .form-group textarea {
            ...
            font-size:.88rem; padding:.75rem 1rem; outline:none;
            transition:border-color .2s, box-shadow .2s;
        }
        .form-group input:focus,
        .form-group select:focus,
        .form-group textarea:focus {
            border-color:var(--lav-dim); box-shadow:0 0 0 3px rgba(167,139,250,.12);
        }
        ...
        .id-badge {
            font-family:'Cinzel',serif; font-size:.75rem; color:var(--lav);
        ...
        .alert-error {
            ...
            border-radius:10px; padding:.85rem 1rem; margin-bottom:1.4rem;
            color:#f9a8d4; font-size:.82rem;
        }
...
<aside class="sidebar">
    ...
    <nav class="nav-sec">
        ...
        <a href="<%= request.getContextPath() %>/home.jsp" class="nav-a">
        ...
        <a href="<%= request.getContextPath() %>/mods" class="nav-a active">
        ...
        <a href="<%= request.getContextPath() %>/utilisateurs.jsp" class="nav-a">
...
<main class="main">
    ...
    <div class="ph">
        ...
        <h1>Modifier le Mod</h1>
        <p class="sub2">Mise à jour des informations du mod</p>
    </div>
    ...
    <div class="form-card">
        ...
        <div class="id-row">
            <span class="id-label">ID du mod</span>
            <span class="id-badge">#<%= String.format("%02d", mod.getId()) %></span>
        </div>
        ...
        <form action="<%= request.getContextPath() %>/updateMod" method="post">
            ...
            <div class="form-group">
                ...
                <select name="category">
                    ...
                    <option value="Graphisme" <%= "Graphisme".equals(mod.getCategory()) ? "selected" : "" %>>Graphisme</option>
                    <option value="Contenu"   <%= "Contenu".equals(mod.getCategory())   ? "selected" : "" %>>Contenu</option>
                </select>
            </div>
    ...
    <!-- Étape 1 : bouton qui affiche la confirmation -->
    <button type="button" class="btn-save" onclick="document.getElementById('confirm-section').style.display='flex'">
    ...
    <a href="<%= request.getContextPath() %>/mods" class="btn-cancel">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:14px;height:14px;">
...
<!-- Étape 2 : section de confirmation -->
<div id="confirm-section" style="display:none; gap:.75rem; margin-top:1rem; padding:1rem;
     background:rgba(167,139,250,.06); border:1px solid var(--border); border-radius:10px;
     align-items:center; justify-content:space-between;">
    <span style="font-size:.82rem; color:var(--text-mid);">
        Confirmer la modification de <strong style="color:var(--lav-light);"><%= mod.getTitle() %></strong> ?
    </span>
    <div style="display:flex; gap:.5rem;">
        <!-- ✅ Bouton qui soumet vraiment le formulaire -->
        <button type="submit" class="btn-save" style="flex:unset; padding:.5rem 1.2rem;">
        ...
        <button type="button" class="btn-cancel"
                onclick="document.getElementById('confirm-section').style.display='none'"
