...
<head>
    ...
    <title>GameVerse Academy — Ajouter un Jeu</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .ph h1{font-family:'Cinzel',serif;font-size:2rem;font-weight:700;background:linear-gradient(135deg,#fff 0%,var(--lav-light) 55%,var(--lav) 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;line-height:1.1;}
        ...
        .alert-success{background:rgba(52,211,153,.1);border:1px solid rgba(52,211,153,.3);border-radius:10px;padding:.85rem 1rem;margin-bottom:1.4rem;color:#6ee7b7;font-size:.82rem;}
    </style>
</head>
<body>
...
<main class="main">
    <div class="ph">
        ...
        <p class="sub2">Remplissez les informations du nouveau jeu</p>
    </div>
    ...
    <div class="form-card">
        ...
        <form action="<%= request.getContextPath() %>/submitGame" method="post">
            <div class="form-grid">
                <div class="form-group">
                    <label>Titre *</label>
                    <input type="text" name="title" placeholder="ex: Skyrim" required/>
                </div>
                <div class="form-group">
                    <label>Genre</label>
                    <select name="genre">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="developer" placeholder="ex: Bethesda Game Studios"/>
                </div>
                <div class="form-group">
                    <label>Éditeur</label>
                    <input type="text" name="publisher" placeholder="ex: Bethesda Softworks"/>
                </div>
